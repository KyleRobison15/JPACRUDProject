...
<!-- ///////////////////////////////////////////// CLIMB ID (HIDDEN) ////////////////////////////////////////////////////////////// -->
		...
		<input name = "id" type = "hidden" value=${climb.id } id = "id">
...
<!-- ///////////////////////////////////////////// ROUTE NAME ////////////////////////////////////////////////////////////// -->
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="routeName" name="routeName" value="${climb.routeName }" required>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<select class="form-select" name="routeGrade" id="routeGrade" aria-label="Default select example">
					<option selected>${climb.routeGrade }</option>
...
<!-- ///////////////////////////////////////////// PITCHES ////////////////////////////////////////////////////////////// -->
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="number" min="0" max="50" class="form-control" id="pitches" name="pitches" value="${climb.pitches }" required>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				...
				<select class="form-select" name="stateAbbreviation" id="stateAbbreviation" aria-label=".form-select-lg example">
					<option selected>${climb.stateAbbreviation }</option>
...
<!-- ///////////////////////////////////////////// AREA NAME ////////////////////////////////////////////////////////////// -->
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="areaName" name="areaName" value="${climb.areaName }">
			</div>
		</div>
...
<!-- ///////////////////////////////////////////// AREA NAME 2 ////////////////////////////////////////////////////////////// -->
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="areaName2" name="areaName2" value="${climb.areaName2 }">
			</div>
		</div>
...
<!-- ///////////////////////////////////////////// CRAG NAME ////////////////////////////////////////////////////////////// -->
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="cragName" name="cragName" value="${climb.cragName }">
			</div>
		</div>
...
<!-- ///////////////////////////////////////////// AREA LATITUDE ////////////////////////////////////////////////////////////// -->
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="areaLatitude" name="areaLatitude" value="${climb.areaLatitude }" required>
			</div>
		</div>
...
<!-- ///////////////////////////////////////////// AREA LONGITUDE ////////////////////////////////////////////////////////////// -->
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="areaLongitude" name="areaLongitude" value="${climb.areaLongitude }" required>
			</div>
		</div>
...
<!-- ///////////////////////////////////////////// STARS ////////////////////////////////////////////////////////////// -->	
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="number" min="0" max="5" class="form-control" id="stars" name="stars" value="${climb.stars }" required>
			</div>
		</div>
...
<!-- ///////////////////////////////////////////// DATE CLIMBED ////////////////////////////////////////////////////////////// -->
 		...
 		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="date" class="form-control" id="dateClimbed" name="dateClimbed" value="${climb.dateClimbed }">
			</div>
		</div> 
